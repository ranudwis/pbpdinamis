        ...
        <div class="row" style="height: 100%; margin-bottom: -70px">
            <div class="col-sm menu">
                <div class="container">
                    ...
                    <a href="{{ url('/penulis/editprofile') }}"><i class="fas fa-desktop"></i>Edit Profil</a>
                    <a href="{{ url('/penulis/post') }}"><i class="fas fa-book"></i>Daftar Postingan</a>
                    <a href="{{ url('/penulis/tambahpost') }}"><i class="fas fa-pencil-alt"></i>Tambah Postingan</a>
                </div>
            </div>
